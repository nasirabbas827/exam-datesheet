<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="index.php">Exam DateSheet Scheduler</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            if (isset($_SESSION["id"]) && !empty($_SESSION["id"])) {
                ...
                echo '<li class="nav-item"><a class="nav-link" href="login.php">Exam Coordinator Login</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="supr_login.php">Superintendent Login</a></li>';
